...
def get_args_parser():
    ...
    parser.add_argument('--num_train_timesteps', default='100', type=int, help="")
    ...
    parser.add_argument('--depth_fut', default='2', type=int, help="Transformer层数")
    ...
    parser.add_argument('--num_train_timesteps_fut', default=100, type=int, help="前馈网络扩展倍数(即hidden_dim乘以该倍率)")
