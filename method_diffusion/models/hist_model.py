...
class DiffusionPast(nn.Module):
    ...
    def init_params(self):
        if self.dataset_name == "ngsim":
            ...
            pos_mean = [0.6586837684014883, -6.136159601126383]
            pos_std = [1.3082316065264188, 4.885463116983893]
            va_mean = [6.1447200255712415, 0.2978122787266646]
            va_std = [2.740439175129506, 0.632888273825017]
            lane_center = [59.0]
            lane_scale = [59.0]
            class_center = [1.0]
            class_scale = [1.0]
