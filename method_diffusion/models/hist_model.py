...
class DiffusionPast(nn.Module):
    ...
    def init_params(self):
        if self.dataset_name == "ngsim":
            pos_mean = [0.015019198890680435, -11.348466970605871]
            pos_std = [0.27427134624608, 10.285794431096745]
            va_mean = [7.550682266987802, 0.026167839824687684]
            va_std = [4.332475850594017, 1.4101725780748295]
            lane_center = [4.0]
            ...
            pos_mean = [-0.010721755644991655, -38.91631901223339]
            pos_std = [0.26509070913994565, 27.264326661765537]
            va_mean = [25.954521089560863, -0.01831914037037093]
            va_std = [7.434363724239614, 0.3273117683059054]
            lane_center = [2.5]
            ...
            pos_mean = [0.09021877209021281, -1.9927295330070416]
            pos_std = [0.17436724129087108, 2.0059875125621023]
            va_mean = [4.958186077589499, -0.10735210033762688]
            va_std = [3.324861203903056, 0.2214549153740375]
            lane_center = [59.0]
            lane_scale = [59.0]
            class_center = [1.0]
            class_scale = [1.0]
